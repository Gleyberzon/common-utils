...
public class DateTime implements Comparable<DateTime>{
   ...
   /* public static void main(String args[]){
    ...
    public static DateTime today() {
        ...
        return new DateTime(calendar.get(Calendar.YEAR), georgianMonth, calendar.get(Calendar.DAY_OF_MONTH), 0, 0, 0);
    }
     ...
     * @since 20.09.2022
     */
    public DateTime convertFromEpoch(Long epoch)
    {
     ...
     * @since 28.09.2022
     */
    public static int getMonthValue(Month month) {
