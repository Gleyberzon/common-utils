            ...
            switch (projectName) {
                ...
                case "allocation":
                    if (warningMessage.getDetails().trim().contains("RQT")) {
                        ...
                        bugNumbers.add(warningMessage.getDetails().trim().substring(11, 14));
                    break;
                case "route_catalog", "iqship_db-proactive_monitor", "helloworld", "data_preparation", "balancing":
