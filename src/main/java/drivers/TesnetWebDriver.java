        ...
        WrapsDriver
{
    ...
    public List<WebElement> findElements(By by) {
        ...
        logger.trace("driver using : findElements " + elements.toString() + " By = " + by.toString() + " elements = " + Arrays.toString(elements.toArray()));
     ...
     * see https://www.selenium.dev/documentation/webdriver/interactions/virtual_authenticator/
     * and https://github.com/SeleniumHQ/seleniumhq.github.io/blob/trunk/examples/java/src/test/java/dev/selenium/virtual_authenticator/VirtualAuthenticatorTest.java#L72-78
     *
     *
